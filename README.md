...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,go,py,perl,html,css,js,ts,gcp,aws,dynamodb,mysql,postgres,sqlite,django,flask,pytorch,tensorflow,react,redux,nextjs,nodejs,bootstrap,tailwind,vite,webpack,babel,git,github,gitlab,docker,linux,bash,postman,discord,atom,vim,vscode,&theme=light)](https://skillicons.dev)
